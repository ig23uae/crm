...
<head>
    ...
    <script src="https://bootstrap-4.ru/docs/5.3/assets/js/color-modes.js"></script>
</head>
<body>
...
<header class="d-flex justify-content-center py-3">
        <ul class="nav nav-pills nav-dark">
            <li class="nav-item"><a href="{{route('cars_index', 'all')}}" class="nav-link @if(Request::is('cars')) active @endif" aria-current="page">Машины</a></li>
            <li class="nav-item"><a href="#" class="nav-link @if(Request::is('sales')) active @endif">Сделки</a></li>
            <li class="nav-item"><a href="{{route('create_sale')}}" class="nav-link @if(Request::is('create_sale')) active @endif">Создать сделку</a></li>
            <li class="nav-item"><a href="{{route('create_client')}}" class="nav-link @if(Request::is('create_client')) active @endif">Регистрация клиента</a></li>
            <li class='nav-item'><a href='' class='nav-link @if(Request::is('employee_sales')) active @endif'>Сделки продавцов</a></li>
            <li class='nav-item'><a href='{{route('clients')}}' class='nav-link @if(Request::is('clients')) active @endif'>Список клиентов</a></li>
            <li class="nav-item"><a href="{{route('panel')}}" class="nav-link">Админ панель</a></li>
        </ul>
</header>
